...
2. **Web ACL Name** 🏷️: Enter **Kenza-waf**. ( Or any name you want lol)  
3. **CloudWatch metric name** 📊: Leave it as **Kenza-waf**. (same as the web acl name)  
